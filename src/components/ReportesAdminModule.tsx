...
export function ReportesAdminModule() {
  ...
  const cargarDatosIniciales = async () => {
    try {
      setCargando(true);
      setError(null);
      const [cursosData, asignaturasData, evaluacionesData, alumnosResponse] =
        await Promise.all([
  ...
  const irADistribucionAsignatura = () =>
    setVistaActual('distribucion-asignatura');
  const irAEvaluacionesPendientes = () =>
    setVistaActual('evaluaciones-pendientes');
  const irANotasAlumno = () => setVistaActual('notas-alumno');
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Reportes avanzados para análisis y supervisión académica
          </p>
        </div>
      </div>
      ...
      <Card className="border-t-4 border-t-blue-600">
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center space-x-4 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        Consulta el top de alumnos con mejor promedio general en
                        cada curso
                      </p>
                  ...
                  <Button
                    size="sm"
                    className="bg-blue-600 hover:bg-blue-700 hidden sm:inline-flex self-start mt-1"
                  >
                    Generar
                  </Button>
                </div>
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center space-x-4 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        Analiza estadísticas de notas: mínimo, máximo, promedio,
                  ...
                  <Button
                    size="sm"
                    className="bg-green-600 hover:bg-green-700 hidden sm:inline-flex self-start mt-1"
                  >
                    Generar
                  </Button>
                </div>
            ...
            {/* Evaluaciones Pendientes */}
            <Card
              className="hover:shadow-md transition-all cursor-pointer group border-l-4 border-l-orange-500 hover:border-l-orange-600 hover:bg-orange-50"
              onClick={irAEvaluacionesPendientes}
            >
              <CardContent className="p-4">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center space-x-4 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        Vista completa agrupada por curso y asignatura.
                        Supervisa el progreso de registro de notas en tiempo
                        real
                      </p>
                  ...
                  <Button
                    size="sm"
                    onClick={irAEvaluacionesPendientes}
                    className="bg-orange-600 hover:bg-orange-700 hidden sm:inline-flex self-start mt-1"
                  >
                    Abrir
                  </Button>
                </div>
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <Button
                    size="sm"
                    className="bg-purple-600 hover:bg-purple-700 hidden sm:inline-flex self-start mt-1"
                  >
                    Generar
                  </Button>
                </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="text-sm text-blue-900">
                <strong>Nota:</strong> Estos reportes institucionales solo están
                disponibles para usuarios con roles de{' '}
                <strong>Administrador</strong> o{' '}
                <strong>Personal Académico</strong>. Los reportes muestran
                información de todos los cursos, asignaturas y evaluaciones del
                sistema.
              </p>
            </div>
          </div>
  ...
  const renderVista = () => {
    ...
    switch (vistaActual) {
      ...
      case 'distribucion-asignatura':
        return (
          <DistribucionAsignaturaView
            asignaturas={asignaturas}
            onVolver={volverAlMenu}
          />
        );
      case 'evaluaciones-pendientes':
        return <EvaluacionesPendientesView onVolver={volverAlMenu} />;
      case 'notas-alumno':
        return <HistorialNotasPage onVolver={volverAlMenu} />;
      default:
        return renderMenu();
    }
  };
